...
const quickFacts = [
  { icon: <MapPin className="h-4 w-4" />, label: "Based in Spokane, WA" },
  {
    ...
    label: "Originally from Hanoi, Vietnam",
  },
  {
    icon: <GraduationCap className="h-4 w-4" />,
    label: "Graduating May 2028",
  },
    ...
    <SectionWrapper>
      <header className="mb-12">
        ...
        <p className="max-w-3xl text-lg leading-relaxed text-muted-foreground">
          ...
          Gonzaga University, with a minor in Leadership Studies. I enjoy
      ...
      <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr]">
        <div className="space-y-5 leading-relaxed text-muted-foreground">
          <p>
            ...
            analytics. Along the way, I have worked across financial analysis,
            business consulting, product and marketing analytics, and community
            programs at Gonzaga's Center for Community Engagement.
          </p>

          <p>
            What ties this together is my curiosity about how businesses
            actually work: the numbers, the people using the reports, and the
            decisions they need to make. I enjoy working between technical and
            business teams, asking questions until the problem is clear, then
            building the SQL query, Python model, or Power BI dashboard that
            answers it.
          </p>

          <p>
            Outside of school and work, I mentor students as a Peer Academic
            Coach, help lead the Vietnamese Student Association, and volunteer
            with Gonzaga's Center for Community Engagement.
          </p>
        </div>
        ...
        <article className="rounded-xl border border-border bg-card p-6 md:p-8">
          ...
          <div className="mt-6 rounded-lg border border-dashed border-border bg-background p-5">
            ...
            <ul className="mt-3 grid gap-1.5 text-sm text-muted-foreground sm:grid-cols-3">
              {education.minor.highlights.map((highlight) => (
                <li key={highlight} className="flex items-start gap-2">
                  <span className="mt-1.5 block h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
                  {highlight}
                </li>
